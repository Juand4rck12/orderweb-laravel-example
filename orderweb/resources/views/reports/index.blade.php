...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                <a href="{{ route('reports.technicians') }}" class="btn btn-danger btn-block btn-lg col-lg-2"
                    title="PDF">
...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="{{ route('reports.activities_technicians') }}" method="POST">
                    @csrf
                    <div class="row form-group">
                        ...
                        <div class="col-lg-5">
                            <button type="submit" class="btn btn-danger btn-block btn-lg col-lg-4 mb-4" title="PDF">
                                <i class="fa-solid fa-file-pdf"></i>
                            </button>
                        </div>
                    </div>
